...
import ponkberry.finalproject.fragment.DemoItemFragment.OnListFragmentInteractionListener;
...
public class DemoRecyclerViewAdapter extends RecyclerView.Adapter<DemoRecyclerViewAdapter.ViewHolder> {
    ...
    private ArrayList<GameObject> mValues;
    private final OnListFragmentInteractionListener mListener;

    public DemoRecyclerViewAdapter(ArrayList<GameObject> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
        ...
        holder.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (null != mListener) {
                    ...
                    mListener.DemoFragmentInteraction(holder.mItem);
                }
            }
        });
    }
