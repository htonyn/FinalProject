package ponkberry.finalproject.service;
...
public class MusicService extends Service {
	// MediaPlayer is a library of Android, but you have to control it manually
	...
	public static final int PLAY_INIT = 1;// Initialize
	public static final int PLAY_MSG = 2;// Play
	public static final int PAUSE_MSG = 3;// Pause
	public static final int CONTINUE_MSG = 4;// Continue
	public static final int SEEKTO_MSG = 5;// Skip to given time

	public static final String MusicServiceStatus = "com.kting.action.MusicServiceStatus";
	...
	private void preparePlay() {
		if (lastURL == null || lastURL.equals(url)) {
			...
			try {
				...
				// If you place a large load in a service, it'll pause the current activity
